...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/ovs?ref=02881b7400c6d2bc424ec9a01235cb1e7ea7c7c9`)
...
func (s *Suite) TestWebhook_smartvf() {
	...
	r.Run(`WH=$(kubectl get pods -l app=admission-webhook-k8s -n nsm-system --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')` + "\n" + `kubectl wait --for=condition=ready --timeout=1m pod ${WH} -n nsm-system`)
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/webhook-smartvf?ref=02881b7400c6d2bc424ec9a01235cb1e7ea7c7c9`)
...
func (s *Suite) TestKernel2KernelVLAN() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Kernel2KernelVLAN?ref=02881b7400c6d2bc424ec9a01235cb1e7ea7c7c9`)
...
func (s *Suite) TestSmartVF2SmartVF() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/SmartVF2SmartVF?ref=02881b7400c6d2bc424ec9a01235cb1e7ea7c7c9`)
