...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/ovs?ref=4a0ec48044729b965bd0a6f161f5fbf2aaf5e0b4`)
...
func (s *Suite) TestWebhook_smartvf() {
	...
	r.Run(`WH=$(kubectl get pods -l app=admission-webhook-k8s -n nsm-system --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')` + "\n" + `kubectl wait --for=condition=ready --timeout=1m pod ${WH} -n nsm-system`)
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/webhook-smartvf?ref=4a0ec48044729b965bd0a6f161f5fbf2aaf5e0b4`)
...
func (s *Suite) TestKernel2KernelVLAN() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Kernel2KernelVLAN?ref=4a0ec48044729b965bd0a6f161f5fbf2aaf5e0b4`)
...
func (s *Suite) TestSmartVF2SmartVF() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/SmartVF2SmartVF?ref=4a0ec48044729b965bd0a6f161f5fbf2aaf5e0b4`)
