...
func (s *Suite) TestNsm_consul() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/d-uzlov/deployments-k8s/examples/interdomain/nsm_consul/nse-auto-scale-client?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/d-uzlov/deployments-k8s/examples/interdomain/nsm_consul/nse-auto-scale-server?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestNsm_istio() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/d-uzlov/deployments-k8s/examples/interdomain/nsm_istio/nse-auto-scale?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestNsm_kuma_universal_vl3() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/d-uzlov/deployments-k8s/examples/interdomain/nsm_kuma_universal_vl3/vl3-dns?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f` + "\n" + `kubectl --kubeconfig=$KUBECONFIG1 -n ns-dns-vl3 wait --for=condition=ready --timeout=5m pod -l app=vl3-ipam`)
