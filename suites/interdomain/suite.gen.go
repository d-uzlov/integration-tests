...
func (s *Suite) TestNsm_consul() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/d-uzlov/deployments-k8s/examples/interdomain/nsm_consul/nse-auto-scale-client?ref=63d2effb4e93b0238bd80c5af9bd899b1245b6ba` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/d-uzlov/deployments-k8s/examples/interdomain/nsm_consul/nse-auto-scale-server?ref=63d2effb4e93b0238bd80c5af9bd899b1245b6ba`)
...
func (s *Suite) TestNsm_istio() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/d-uzlov/deployments-k8s/examples/interdomain/nsm_istio/nse-auto-scale?ref=63d2effb4e93b0238bd80c5af9bd899b1245b6ba`)
...
func (s *Suite) TestNsm_kuma_universal_vl3() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/d-uzlov/deployments-k8s/examples/interdomain/nsm_kuma_universal_vl3/vl3-dns?ref=63d2effb4e93b0238bd80c5af9bd899b1245b6ba` + "\n" + `kubectl --kubeconfig=$KUBECONFIG1 -n ns-dns-vl3 wait --for=condition=ready --timeout=5m pod -l app=vl3-ipam`)
