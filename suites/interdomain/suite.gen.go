...
func (s *Suite) TestNsm_consul() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/d-uzlov/deployments-k8s/examples/interdomain/nsm_consul/nse-auto-scale-client?ref=02881b7400c6d2bc424ec9a01235cb1e7ea7c7c9` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/d-uzlov/deployments-k8s/examples/interdomain/nsm_consul/nse-auto-scale-server?ref=02881b7400c6d2bc424ec9a01235cb1e7ea7c7c9`)
...
func (s *Suite) TestNsm_istio() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/d-uzlov/deployments-k8s/examples/interdomain/nsm_istio/nse-auto-scale?ref=02881b7400c6d2bc424ec9a01235cb1e7ea7c7c9`)
...
func (s *Suite) TestNsm_kuma_universal_vl3() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/d-uzlov/deployments-k8s/examples/interdomain/nsm_kuma_universal_vl3/vl3-dns?ref=02881b7400c6d2bc424ec9a01235cb1e7ea7c7c9` + "\n" + `kubectl --kubeconfig=$KUBECONFIG1 -n ns-dns-vl3 wait --for=condition=ready --timeout=5m pod -l app=vl3-ipam`)
