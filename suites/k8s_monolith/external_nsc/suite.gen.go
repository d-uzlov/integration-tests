...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/k8s_monolith/configuration/cluster?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
...
func (s *Suite) TestKernel2IP2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/k8s_monolith/external_nsc/usecases/Kernel2IP2Kernel?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
