...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/k8s_monolith/configuration/cluster?ref=4a0ec48044729b965bd0a6f161f5fbf2aaf5e0b4`)
...
func (s *Suite) TestKernel2IP2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/k8s_monolith/external_nse/usecases/Kernel2IP2Kernel?ref=4a0ec48044729b965bd0a6f161f5fbf2aaf5e0b4`)
