...
func (s *Suite) TestDataplane_interrupt() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/dataplane-interrupt?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestLocal_forwarder_death() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/local-forwarder-death?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestLocal_forwarder_remote_forwarder() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/local-forwarder-remote-forwarder?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestLocal_nse_death() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/local-nse-death/nse-before-death?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/local-nse-death/nse-after-death?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestLocal_nsm_system_restart() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/local-nsm-system-restart?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/basic?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
	r.Run(`kubectl exec pods/alpine -n ns-local-nsm-system-restart -- ping -c 4 172.16.1.100`)
	r.Run(`kubectl exec deployments/nse-kernel -n ns-local-nsm-system-restart -- ping -c 4 172.16.1.101`)
}
func (s *Suite) TestLocal_nsmgr_local_forwarder_memif() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/local-nsmgr-local-forwarder-memif?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestLocal_nsmgr_local_nse_memif() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/local-nsmgr-local-nse-memif/nse-before-death?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
	...
	r.Run(`NSMGR=$(kubectl get pods -l app=nsmgr --field-selector spec.nodeName==${NSC_NODE} -n nsm-system --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
	r.Run(`kubectl delete pod ${NSMGR} -n nsm-system`)
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/local-nsmgr-local-nse-memif/nse-after-death?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
	r.Run(`kubectl wait --for=condition=ready --timeout=1m pod -l app=nsmgr --field-selector spec.nodeName==${NSC_NODE} -n nsm-system`)
...
func (s *Suite) TestLocal_nsmgr_remote_nsmgr() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/local-nsmgr-remote-nsmgr?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestLocal_nsmgr_restart() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/local-nsmgr-restart?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestRegistry_local_endpoint() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/registry-local-endpoint/nse-first?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/registry-local-endpoint/nse-second?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestRegistry_remote_forwarder() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/registry-remote-forwarder?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestRegistry_remote_nsmgr() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/registry-remote-nsmgr?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestRegistry_restart() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/registry-restart/registry-before-death?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
	...
	r.Run(`kubectl delete pod ${REGISTRY} -n nsm-system`)
	r.Run(`kubectl wait --for=condition=ready --timeout=1m pod -l app=registry -n nsm-system`)
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/registry-restart/registry-after-death?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestRemote_forwarder_death() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/remote-forwarder-death?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestRemote_forwarder_death_ip() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/remote-forwarder-death-ip?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestRemote_nse_death() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/remote-nse-death/nse-before-death?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/remote-nse-death/nse-after-death?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestRemote_nse_death_ip() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/remote-nse-death-ip/nse-before-death?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/remote-nse-death-ip/nse-after-death?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestRemote_nsm_system_restart_memif_ip() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/remote-nsm-system-restart-memif-ip?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestRemote_nsmgr_death() {
	...
	s.T().Cleanup(func() {
		r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/apps/nsmgr?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f -n nsm-system`)
		r.Run(`kubectl delete ns ns-remote-nsmgr-death`)
	})
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/remote-nsmgr-death/remote-nse?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/remote-nsmgr-death/nsmgr-death?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/remote-nsmgr-death/local-nse?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestRemote_nsmgr_remote_endpoint() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/remote-nsmgr-remote-endpoint/nsmgr-before-death?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
	...
	r.Run(`NSMGR=$(kubectl get pods -l app=nsmgr --field-selector spec.nodeName==${NSE_NODE} -n nsm-system --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')`)
	r.Run(`kubectl delete pod ${NSMGR} -n nsm-system`)
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/remote-nsmgr-remote-endpoint/nsmgr-after-death?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
	r.Run(`kubectl wait --for=condition=ready --timeout=1m pod -l app=nsmgr --field-selector spec.nodeName==${NSE_NODE} -n nsm-system`)
...
func (s *Suite) TestRemote_nsmgr_restart() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/remote-nsmgr-restart?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestRemote_nsmgr_restart_ip() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/remote-nsmgr-restart-ip?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestSpire_agent_restart() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/spire-agent-restart?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestSpire_server_agent_restart() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/spire-server-agent-restart?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestSpire_server_restart() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/spire-server-restart?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestSpire_upgrade() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/spire-upgrade?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/spire/single_cluster?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
	r.Run(`kubectl wait --for=condition=ready --timeout=1m pod -l app=spire-server -n spire`)
	r.Run(`kubectl wait --for=condition=ready --timeout=1m pod -l app=spire-agent -n spire`)
...
func (s *Suite) TestVl3_nscs_death() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/vl3-nscs-death?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestVl3_nse_death() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/heal/vl3-nse-death?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
