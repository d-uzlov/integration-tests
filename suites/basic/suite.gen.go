...
func (s *Suite) TestKernel2Ethernet2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Kernel2Ethernet2Kernel?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestKernel2Ethernet2Memif() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Kernel2Ethernet2Memif?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestKernel2IP2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Kernel2IP2Kernel?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestKernel2IP2Memif() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Kernel2IP2Memif?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestKernel2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Kernel2Kernel?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestKernel2Memif() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Kernel2Memif?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestMemif2Ethernet2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Memif2Ethernet2Kernel?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestMemif2Ethernet2Memif() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Memif2Ethernet2Memif?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestMemif2IP2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Memif2IP2Kernel?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestMemif2IP2Memif() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Memif2IP2Memif?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestMemif2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Memif2Kernel?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestMemif2Memif() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Memif2Memif?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
