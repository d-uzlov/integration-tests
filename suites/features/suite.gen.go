...
func (s *Suite) TestAnnotated_namespace() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/annotated-namespace?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestDns() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/dns?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestKernel2IP2Kernel_dual_stack() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/dual-stack/Kernel2IP2Kernel_dual_stack?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestKernel2Kernel_dual_stack() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/dual-stack/Kernel2Kernel_dual_stack?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestExclude_prefixes() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/exclude-prefixes/configmap?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/exclude-prefixes?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestExclude_prefixes_client() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/exclude-prefixes-client?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestKernel2IP2Kernel_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/ipv6/Kernel2IP2Kernel_ipv6?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestKernel2IP2Memif_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/ipv6/Kernel2IP2Memif_ipv6?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestKernel2Kernel_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/ipv6/Kernel2Kernel_ipv6?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestMemif2IP2Kernel_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/ipv6/Memif2IP2Kernel_ipv6?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestMemif2IP2Memif_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/ipv6/Memif2IP2Memif_ipv6?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestMemif2Memif_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/ipv6/Memif2Memif_ipv6?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestMutually_aware_nses() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/mutually-aware-nses?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestNse_composition() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/nse-composition?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestOpa() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/opa?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestPolicy_based_routing() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/policy-based-routing?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestScale_from_zero() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/scale-from-zero?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestSelect_forwarder() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/select-forwarder?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestVl3_basic() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/vl3-basic?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestVl3_dns() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/vl3-dns?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestVl3_scale_from_zero() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/vl3-scale-from-zero?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestWebhook() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/webhook?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
