...
func (s *Suite) TestAnnotated_namespace() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/annotated-namespace?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
	...
	r.Run(`kubectl apply -f https://raw.githubusercontent.com/d-uzlov/deployments-k8s/4a0ec48044729b965bd0a6f161f5fbf2aaf5e0b4/examples/features/annotated-namespace/client.yaml`)
...
func (s *Suite) TestDns() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/dns?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
...
func (s *Suite) TestKernel2IP2Kernel_dual_stack() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/dual-stack/Kernel2IP2Kernel_dual_stack?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
...
func (s *Suite) TestKernel2Kernel_dual_stack() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/dual-stack/Kernel2Kernel_dual_stack?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
...
func (s *Suite) TestExclude_prefixes() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/exclude-prefixes/configmap?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/exclude-prefixes?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
...
func (s *Suite) TestExclude_prefixes_client() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/exclude-prefixes-client?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
...
func (s *Suite) TestKernel2IP2Kernel_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/ipv6/Kernel2IP2Kernel_ipv6?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
...
func (s *Suite) TestKernel2IP2Memif_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/ipv6/Kernel2IP2Memif_ipv6?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
...
func (s *Suite) TestKernel2Kernel_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/ipv6/Kernel2Kernel_ipv6?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
...
func (s *Suite) TestMemif2IP2Kernel_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/ipv6/Memif2IP2Kernel_ipv6?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
...
func (s *Suite) TestMemif2IP2Memif_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/ipv6/Memif2IP2Memif_ipv6?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
...
func (s *Suite) TestMemif2Memif_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/ipv6/Memif2Memif_ipv6?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
...
func (s *Suite) TestMutually_aware_nses() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/mutually-aware-nses?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
...
func (s *Suite) TestNse_composition() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/nse-composition?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
...
func (s *Suite) TestOpa() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/opa?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
...
func (s *Suite) TestPolicy_based_routing() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/policy-based-routing?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
...
func (s *Suite) TestScale_from_zero() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/scale-from-zero?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
...
func (s *Suite) TestSelect_forwarder() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/select-forwarder?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
...
func (s *Suite) TestVl3_basic() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/vl3-basic?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
...
func (s *Suite) TestVl3_dns() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/vl3-dns?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
...
func (s *Suite) TestVl3_scale_from_zero() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/vl3-scale-from-zero?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
...
func (s *Suite) TestWebhook() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/webhook?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
