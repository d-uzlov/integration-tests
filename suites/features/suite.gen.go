...
func (s *Suite) TestAnnotated_namespace() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/annotated-namespace?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestDns() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/dns?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestKernel2IP2Kernel_dual_stack() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/dual-stack/Kernel2IP2Kernel_dual_stack?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestKernel2Kernel_dual_stack() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/dual-stack/Kernel2Kernel_dual_stack?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestExclude_prefixes() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/exclude-prefixes/configmap?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/exclude-prefixes?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestExclude_prefixes_client() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/exclude-prefixes-client?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestKernel2IP2Kernel_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/ipv6/Kernel2IP2Kernel_ipv6?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestKernel2IP2Memif_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/ipv6/Kernel2IP2Memif_ipv6?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestKernel2Kernel_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/ipv6/Kernel2Kernel_ipv6?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestMemif2IP2Kernel_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/ipv6/Memif2IP2Kernel_ipv6?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestMemif2IP2Memif_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/ipv6/Memif2IP2Memif_ipv6?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestMemif2Memif_ipv6() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/ipv6/Memif2Memif_ipv6?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestMutually_aware_nses() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/mutually-aware-nses?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestNse_composition() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/nse-composition?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestOpa() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/opa?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestPolicy_based_routing() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/policy-based-routing?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestScale_from_zero() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/scale-from-zero?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestSelect_forwarder() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/select-forwarder?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestVl3_basic() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/vl3-basic?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestVl3_dns() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/vl3-dns?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestVl3_scale_from_zero() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/vl3-scale-from-zero?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestWebhook() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/features/webhook?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
