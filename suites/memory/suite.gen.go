...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/memory?ref=63d2effb4e93b0238bd80c5af9bd899b1245b6ba`)
...
func (s *Suite) TestKernel2Ethernet2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/memory/Kernel2Ethernet2Kernel?ref=63d2effb4e93b0238bd80c5af9bd899b1245b6ba`)
...
func (s *Suite) TestKernel2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/memory/Kernel2Kernel?ref=63d2effb4e93b0238bd80c5af9bd899b1245b6ba`)
...
func (s *Suite) TestMemif2Memif() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/memory/Memif2Memif?ref=63d2effb4e93b0238bd80c5af9bd899b1245b6ba`)
