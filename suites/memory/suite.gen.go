...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/memory?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
...
func (s *Suite) TestKernel2Ethernet2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/memory/Kernel2Ethernet2Kernel?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
...
func (s *Suite) TestKernel2Kernel() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/memory/Kernel2Kernel?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
...
func (s *Suite) TestMemif2Memif() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/memory/Memif2Memif?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
