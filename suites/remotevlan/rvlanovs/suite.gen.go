...
func (s *Suite) SetupSuite() {
	...
	s.T().Cleanup(func() {
		r.Run(`kubectl delete -k https://github.com/d-uzlov/deployments-k8s/examples/remotevlan/rvlanovs?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
	})
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/remotevlan/rvlanovs?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestKernel2RVlanBreakout() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Kernel2RVlanBreakout?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestKernel2RVlanInternal() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Kernel2RVlanInternal?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
...
func (s *Suite) TestKernel2RVlanMultiNS() {
	...
	s.T().Cleanup(func() {
		r.Run(`docker stop rvm-tester && \` + "\n" + `docker image rm rvm-tester:latest` + "\n" + `true`)
		r.Run(`kubectl delete --namespace=nsm-system -f https://raw.githubusercontent.com/d-uzlov/deployments-k8s/4a0ec48044729b965bd0a6f161f5fbf2aaf5e0b4/examples/use-cases/Kernel2RVlanMultiNS/client.yaml`)
		r.Run(`kubectl delete ns ns-kernel2vlan-multins-1`)
		r.Run(`kubectl delete ns ns-kernel2vlan-multins-2`)
	})
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-1?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
	r.Run(`kubectl apply -f https://raw.githubusercontent.com/d-uzlov/deployments-k8s/4a0ec48044729b965bd0a6f161f5fbf2aaf5e0b4/examples/use-cases/Kernel2RVlanMultiNS/ns-2/ns-kernel2vlan-multins-2.yaml` + "\n" + `kubectl apply -f https://raw.githubusercontent.com/d-uzlov/deployments-k8s/4a0ec48044729b965bd0a6f161f5fbf2aaf5e0b4/examples/use-cases/Kernel2RVlanMultiNS/ns-2/netsvc.yaml` + "\n" + `kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-2?ref=a54ae4d4a3f823c30a896ed64e82e9f963a0d12f`)
	r.Run(`kubectl apply -n nsm-system -f https://raw.githubusercontent.com/d-uzlov/deployments-k8s/4a0ec48044729b965bd0a6f161f5fbf2aaf5e0b4/examples/use-cases/Kernel2RVlanMultiNS/client.yaml`)
