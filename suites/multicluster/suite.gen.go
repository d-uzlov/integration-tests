...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/clusters-configuration/cluster1?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/clusters-configuration/cluster2?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/clusters-configuration/cluster3?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
...
func (s *Suite) TestFloating_Kernel2Ethernet2Kernel() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_Kernel2Ethernet2Kernel/cluster3?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_Kernel2Ethernet2Kernel/cluster2?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_Kernel2Ethernet2Kernel/cluster1?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
...
func (s *Suite) TestFloating_Kernel2IP2Kernel() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_Kernel2IP2Kernel/cluster3?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_Kernel2IP2Kernel/cluster2?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_Kernel2IP2Kernel/cluster1?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
...
func (s *Suite) TestFloating_dns() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_dns/cluster3?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_dns/cluster2?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_dns/cluster1?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
...
func (s *Suite) TestFloating_nse_composition() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_nse_composition/cluster3?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_nse_composition/cluster2?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_nse_composition/cluster1?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
...
func (s *Suite) TestFloating_vl3_basic() {
	...
	s.T().Cleanup(func() {
		r.Run(`kubectl --kubeconfig=$KUBECONFIG3 delete -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_vl3-basic/cluster3?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
		r.Run(`kubectl --kubeconfig=$KUBECONFIG2 delete -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_vl3-basic/cluster2?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
		r.Run(`kubectl --kubeconfig=$KUBECONFIG1 delete -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_vl3-basic/cluster1?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
	})
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_vl3-basic/cluster3?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_vl3-basic/cluster1?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_vl3-basic/cluster2?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
...
func (s *Suite) TestFloating_vl3_dns() {
	...
	s.T().Cleanup(func() {
		r.Run(`kubectl --kubeconfig=$KUBECONFIG3 delete -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_vl3-dns/cluster3?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
		r.Run(`kubectl --kubeconfig=$KUBECONFIG2 delete -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_vl3-dns/cluster2?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
		r.Run(`kubectl --kubeconfig=$KUBECONFIG1 delete -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_vl3-dns/cluster1?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
	})
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_vl3-dns/cluster3?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_vl3-dns/cluster1?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 wait --for=condition=ready --timeout=5m pod -l app=alpine -n ns-floating-vl3-dns`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_vl3-dns/cluster2?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
...
func (s *Suite) TestFloating_vl3_scale_from_zero() {
	...
	s.T().Cleanup(func() {
		r.Run(`kubectl --kubeconfig=$KUBECONFIG3 delete -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_vl3-scale-from-zero/cluster3?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
		r.Run(`kubectl --kubeconfig=$KUBECONFIG2 delete -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_vl3-scale-from-zero/cluster2?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
		r.Run(`kubectl --kubeconfig=$KUBECONFIG1 delete -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_vl3-scale-from-zero/cluster1?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
	})
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_vl3-scale-from-zero/cluster3?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_vl3-scale-from-zero/cluster1?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/floating_vl3-scale-from-zero/cluster2?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
...
func (s *Suite) TestInterdomain_Kernel2Ethernet2Kernel() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/interdomain_Kernel2Ethernet2Kernel/cluster2?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/interdomain_Kernel2Ethernet2Kernel/cluster1?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
...
func (s *Suite) TestInterdomain_Kernel2IP2Kernel() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/interdomain_Kernel2IP2Kernel/cluster2?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/interdomain_Kernel2IP2Kernel/cluster1?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
...
func (s *Suite) TestInterdomain_dns() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/interdomain_dns/cluster2?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/d-uzlov/deployments-k8s/examples/multicluster/usecases/interdomain_dns/cluster1?ref=41407ca07ccc0454f9708e7a5f82657b0f0c24fc`)
