...
func (s *Suite) TestKernel2Ethernet2Kernel_Vfio2Noop() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Kernel2Ethernet2Kernel_Vfio2Noop?ref=4a0ec48044729b965bd0a6f161f5fbf2aaf5e0b4`)
...
func (s *Suite) TestKernel2Kernel_Vfio2Noop() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Kernel2Kernel_Vfio2Noop?ref=4a0ec48044729b965bd0a6f161f5fbf2aaf5e0b4`)
...
func (s *Suite) TestSriovKernel2Noop() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/SriovKernel2Noop/ponger?ref=4a0ec48044729b965bd0a6f161f5fbf2aaf5e0b4`)
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/SriovKernel2Noop?ref=4a0ec48044729b965bd0a6f161f5fbf2aaf5e0b4`)
...
func (s *Suite) TestVfio2Noop() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Vfio2Noop?ref=4a0ec48044729b965bd0a6f161f5fbf2aaf5e0b4`)
