...
func (s *Suite) TestKernel2Ethernet2Kernel_Vfio2Noop() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Kernel2Ethernet2Kernel_Vfio2Noop?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestKernel2Kernel_Vfio2Noop() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Kernel2Kernel_Vfio2Noop?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestSriovKernel2Noop() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/SriovKernel2Noop/ponger?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/SriovKernel2Noop?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
...
func (s *Suite) TestVfio2Noop() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Vfio2Noop?ref=f3d8e97881a29f22b150bfcd6233647c5f96ee68`)
