...
func (s *Suite) TestKernel2Ethernet2Kernel_Vfio2Noop() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Kernel2Ethernet2Kernel_Vfio2Noop?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
...
func (s *Suite) TestKernel2Kernel_Vfio2Noop() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Kernel2Kernel_Vfio2Noop?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
...
func (s *Suite) TestSriovKernel2Noop() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/SriovKernel2Noop/ponger?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/SriovKernel2Noop?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
...
func (s *Suite) TestVfio2Noop() {
	...
	r.Run(`kubectl apply -k https://github.com/d-uzlov/deployments-k8s/examples/use-cases/Vfio2Noop?ref=40e76b2726cd8cb8f541d0c64bb17acf5f79ea50`)
